...
<script>
	...
	function getSubjectList(text){
       	...
       	$(text.subjectsBeanList).each(function(i,val) {
       		...
       		trStr = trStr +"<p class=\"received_zy_s50414\" onclick=\"updateSubject("+val.subjectId+")\">更新发布</p>";
	...
	function getdata(){
		$.ajax({
			async : false,
			type : "post",
			url : "${pageContext.request.contextPath}/subject/getsubjectbyadminid.do",
			data : {
				pageIndex : page
			},
			dataType : "json",
	...
	function updateSubject(e){
		window.location.href="${applicationScope.webhost}pages/subject/updateSubject.jsp?subjectId="+e;
	}
</script>
<title>已发布课程</title>
</head>
    ...
    <!--最近学习-->     
     <div class="right_video_s50407">
      <div class="right_vireo_title_s50407">
        <p><input class="button_orange_131x25_s50413" type="button" value="发布新课程"/></p>
      <h3>已发布课程<b id="subjectNum"></b></h3></div>
